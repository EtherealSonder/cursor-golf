// O6 final Water optimization: preserve the complete O3.2/O5 profiler API for final validation.
...
export interface WaterPerformanceSnapshot {
    ...
    readonly groundWaterCandidatesAverage: number; readonly groundInfiltratingCellsAverage: number;
    readonly groundMoistureCandidatesAverage: number; readonly groundDiffusionPassesAverage: number;
    readonly groundDryingPassesAverage: number; readonly groundShallowCandidatesAverage: number;
...
export class WaterPerformanceProfiler {
    ...
    private groundWorkload = { waterCandidates:0, infiltratingCells:0, moistureCandidates:0, diffusionPasses:0, dryingPasses:0, shallowWaterCandidates:0 };
    ...
    public recordGroundInteractionWorkload(w:{readonly waterCandidates:number;readonly infiltratingCells:number;readonly moistureCandidates:number;readonly diffusionPasses:number;readonly dryingPasses:number;readonly shallowWaterCandidates:number;}):void { if(!this.definition.enabled)return;this.groundWorkload.waterCandidates+=w.waterCandidates;this.groundWorkload.infiltratingCells+=w.infiltratingCells;this.groundWorkload.moistureCandidates+=w.moistureCandidates;this.groundWorkload.diffusionPasses+=w.diffusionPasses;this.groundWorkload.dryingPasses+=w.dryingPasses;this.groundWorkload.shallowWaterCandidates+=w.shallowWaterCandidates; }
...
wetDeepAcceptedLoops:wetDeep?.acceptedLoops??0,wetDeepRawVertices:wetDeep?.rawVertices??0,wetDeepFinalVertices:wetDeep?.finalVertices??0};
    ...
    private createEmptySnapshot(): WaterPerformanceSnapshot {
        return {
            ...
            groundWaterCandidatesAverage: 0, groundInfiltratingCellsAverage: 0, groundMoistureCandidatesAverage: 0,
            groundDiffusionPassesAverage: 0, groundDryingPassesAverage: 0, groundShallowCandidatesAverage: 0,
