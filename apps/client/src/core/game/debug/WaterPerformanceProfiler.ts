...
export class WaterPerformanceProfiler {
    ...
    private standingDetails = { scan: {total:0,samples:0}, contour:{total:0,samples:0}, graphics:{total:0,samples:0}, reflection:{total:0,samples:0}, bodyContours:0, accentContours:0, bodyVertices:0, accentVertices:0 };
    private wetDetails = { membership:{total:0,samples:0}, contour:{total:0,samples:0}, graphics:{total:0,samples:0}, visibleWetCells:0, contours:0, vertices:0 };
    ...
    private publishSnapshot():void {
        const names:ProfileTimingName[]=["surface","waterSources","airborneWater","waterFireInteraction","waterSimulation","waterGroundInteraction","moistureSurfaceBridge","wetGround","standingWater","hoseWaterVfx","sprinklerWaterVfx","fireSimulation","firePresentation","entities","hoseBallForce","ballTrail","dynamicCollisions","hoseCollisions","mechanismSync","waterObstacleSync","windPresentation","gameplayPresentation","debugAndMetrics"];
        const measured=names.reduce((s,n)=>s+this.average(n),0);const worldAverage=this.worldFrameSamples>0?this.worldFrameTotal/this.worldFrameSamples:0;const actual=this.actualFrameSamples>0?this.actualFrameTotal/this.actualFrameSamples:0;
...
wetDeepAcceptedLoops:wetDeep?.acceptedLoops??0,wetDeepRawVertices:wetDeep?.rawVertices??0,wetDeepFinalVertices:wetDeep?.finalVertices??0};
        ...
        this.timings.clear();this.worldFrameTotal=0;this.worldFramePeak=0;this.worldFrameSamples=0;this.actualFrameTotal=0;this.actualFrameSamples=0;this.standingTexture={commits:0,texels:0};this.wetTexture={commits:0,texels:0};this.otherTexture={commits:0,texels:0};this.standingDetails.scan={total:0,samples:0};this.standingDetails.contour={total:0,samples:0};this.standingDetails.graphics={total:0,samples:0};this.standingDetails.reflection={total:0,samples:0};this.wetDetails.membership={total:0,samples:0};this.wetDetails.contour={total:0,samples:0};this.wetDetails.graphics={total:0,samples:0};this.sprinklerDeepDetails.sourceBookkeeping={total:0,samples:0};this.sprinklerDeepDetails.packetTraversal={total:0,samples:0};this.sprinklerDeepDetails.packetPreparation={total:0,samples:0};this.sprinklerDeepDetails.rendererSync={total:0,samples:0};this.sprinklerDeepDetails.legacyHide={total:0,samples:0};this.sprinklerDeepDetails.dropletBegin={total:0,samples:0};this.sprinklerDeepDetails.slotLookupCreate={total:0,samples:0};this.sprinklerDeepDetails.transform={total:0,samples:0};this.sprinklerDeepDetails.geometry={total:0,samples:0};this.sprinklerDeepDetails.style={total:0,samples:0};this.sprinklerDeepDetails.dropletEnd={total:0,samples:0};this.groundBreakdown={contactWetting:0,infiltration:0,moistureDiffusion:0,groundDrying:0,shallowWaterDissipation:0,samples:0};
    }
