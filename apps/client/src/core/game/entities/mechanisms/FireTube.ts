...
export class FireTube extends Entity {
     ...
     * so the presentation transform and authoritative Fire source must be
     * synchronized again in the same frame.
     */
    public synchronizeAfterCollisionResolution(): void {
